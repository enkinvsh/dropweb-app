...
<sub>Приложение не предназначено для обхода блокировок или нарушения законодательства. Используйте для доступа к зарубежным AI-сервисам (ChatGPT, Claude, Midjourney), удалённой работы и других легальных целей. Ответственность за использование несёт пользователь.</sub>
